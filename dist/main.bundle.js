...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"AddFun\": () => (/* binding */ AddFun),\n/* harmony export */   \"DelFun\": () => (/* binding */ DelFun),\n/* harmony export */   \"EditFun\": () => (/* binding */ EditFun),\n/* harmony export */   \"OkFun\": () => (/* binding */ OkFun),\n/* harmony export */   \"checkFun\": () => (/* binding */ checkFun),\n/* harmony export */   \"copyList\": () => (/* binding */ copyList)\n/* harmony export */ });\n/* harmony import */ var _complete_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./complete.js */ \"./src/modules/complete.js\");\n/* harmony import */ var _UpdateToDoList_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./UpdateToDoList.js */ \"./src/modules/UpdateToDoList.js\");\n\n\n\nlet toDoList = [];\nconst copyList = () => toDoList;\nconst UpdateStorage = () => localStorage.setItem('to_do_list', JSON.stringify(toDoList));\n\nconst DelFun = (i) => {\n  toDoList = (0,_UpdateToDoList_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n  toDoList = toDoList.filter((item) => item.index !== i);\n  const listItem = document.querySelectorAll('.item');\n  listItem[i].remove();\n  UpdateStorage();\n};\n\nconst EditFun = (i) => {\n  toDoList = (0,_UpdateToDoList_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n  const editField = document.querySelectorAll('.edit-field');\n  editField[i].value = toDoList[i].description;\n  editField[i].focus();\n  UpdateStorage();\n};\n\nconst checkFun = (i) => {\n  toDoList = (0,_UpdateToDoList_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n  const checkIcon = document.querySelectorAll('.check-icon');\n  toDoList[i].completed = (0,_complete_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(checkIcon[i].checked);\n  UpdateStorage();\n};\n\nconst OkFun = (i) => {\n  toDoList = (0,_UpdateToDoList_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n  const editField = document.querySelectorAll('.edit-field');\n  const span = document.querySelectorAll('.task-text');\n  toDoList.forEach((item) => {\n    if (item.index === i) {\n      item.description = editField[i].value;\n    }\n  });\n  span[i].innerHTML = editField[i].value;\n  UpdateStorage();\n};\n\nconst AddFun = () => {\n  toDoList = (0,_UpdateToDoList_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n  const addField = document.getElementById('add-field');\n  const index = (toDoList.length !== 0) ? toDoList[toDoList.length - 1].index + 1 : 0;\n  toDoList.push({\n    description: addField.value,\n    completed: false,\n    index,\n  });\n  UpdateStorage();\n};\n\n\n\n\n//# sourceURL=webpack://to-do-list-project/./src/modules/util.js?");
...
eval("module.exports = __webpack_require__.p + \"50f11f989deb97e7e1fa.png\";\n\n//# sourceURL=webpack://to-do-list-project/./src/images/drag.png?");
...
eval("module.exports = __webpack_require__.p + \"5c3f0cd636350fc9537f.png\";\n\n//# sourceURL=webpack://to-do-list-project/./src/images/refresh.png?");
